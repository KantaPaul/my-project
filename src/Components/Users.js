    ...
    <div className={global.cardHeader}>
      <div className={props.classes}>
        ...
        <div className={global.rightCotent}>
          <ul className={[lists.lists, lists.listinline].join(' ')}>
            <li><img src={require('../assets/icons/calender.png')} alt="calendar" /></li>
            <li><img src={require('../assets/icons/clock.png')} alt="clock" /></li>
            <li><img src={require('../assets/icons/tag.png')} alt="tag" /></li>
            <li><img src={require('../assets/icons/upload.png')} alt="upload" /></li>
            <li><img src={require('../assets/icons/attach.png')} alt="attach" /></li>
            <li><img src={require('../assets/icons/star.png')} alt="star" /></li>
          </ul>
        </div>
      </div>
    </div>
